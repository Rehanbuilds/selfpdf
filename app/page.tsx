      ...
      <main className="flex-1">
        ...
        <section className="border-b py-16 md:py-24">
          <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[.85fr_1.15fr] lg:px-8">
            <div className="flex flex-col items-start"><Badge className="mb-4 bg-primary/10 text-primary hover:bg-primary/15">PDF Editor</Badge><h2 className="text-balance text-3xl font-bold tracking-tight sm:text-4xl">Create. Edit. Export.</h2><p className="mt-4 text-pretty text-lg leading-7 text-muted-foreground">A powerful PDF editor that works directly in your browser. Create a PDF from scratch or edit an existing document with text, images, shapes, tables, drawings, and signature placement.</p><p className="mt-3 text-sm text-muted-foreground">Free, no signup, privacy-focused, and open source.</p><EditorBuildingNotice /></div>
