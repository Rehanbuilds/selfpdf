    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="border-b py-16 md:py-24">
          <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[.85fr_1.15fr] lg:px-8">
            <div className="flex flex-col items-start"><Badge className="mb-4 bg-primary/10 text-primary hover:bg-primary/15">PDF Editor</Badge><h2 className="text-balance text-3xl font-bold tracking-tight sm:text-4xl">Create. Edit. Export.</h2><p className="mt-4 text-pretty text-lg leading-7 text-muted-foreground">A powerful PDF editor that works directly in your browser. Create a PDF from scratch or edit an existing document with text, images, shapes, tables, drawings, and signature placement.</p><p className="mt-3 text-sm text-muted-foreground">Free, no signup, privacy-focused, and open source.</p><Button className="mt-7" size="lg" asChild><Link href="/pdf-editor">Open PDF Editor <ArrowRight className="ml-2 size-4" /></Link></Button><span className="mt-3 text-sm text-muted-foreground">Start with a blank page or open an existing PDF.</span></div>
            <div className="relative overflow-hidden rounded-2xl border bg-muted/30 p-4 shadow-sm sm:p-6"><div className="mb-4 flex items-center justify-between rounded-lg border bg-background px-3 py-2 text-xs text-muted-foreground"><span className="font-semibold text-foreground">SelfPDF Editor</span><span>100% local processing</span></div><div className="grid gap-4 sm:grid-cols-[72px_1fr]"><div className="hidden gap-2 sm:flex sm:flex-col"><div className="aspect-[.7] rounded border-2 border-primary bg-background p-1"><div className="size-full bg-muted/50" /></div><div className="aspect-[.7] rounded border bg-background p-1"><div className="size-full bg-muted/50" /></div><div className="aspect-[.7] rounded border bg-background p-1"><div className="size-full bg-muted/50" /></div></div><div className="relative aspect-[.82] rounded-md border bg-background p-7 shadow-sm"><div className="flex flex-col gap-4"><div className="h-3 w-2/3 rounded bg-foreground/80" /><div className="h-2 w-full rounded bg-muted-foreground/30" /><div className="h-2 w-5/6 rounded bg-muted-foreground/30" /><div className="mt-4 grid grid-cols-2 gap-3"><div className="flex h-24 items-center justify-center rounded border-2 border-dashed border-primary/60 bg-primary/5 text-xs text-primary">Image</div><div className="grid grid-cols-3 grid-rows-3"><span className="border border-primary/40" /><span className="border border-primary/40" /><span className="border border-primary/40" /><span className="border border-primary/40" /><span className="border border-primary/40" /><span className="border border-primary/40" /><span className="border border-primary/40" /><span className="border border-primary/40" /><span className="border border-primary/40" /></div></div><div className="mt-5 h-12 w-1/2 rounded border-2 border-primary/40 bg-primary/5 p-2 text-xs text-primary">Edit this text</div></div></div></div></div>
          </div>
        </section>
